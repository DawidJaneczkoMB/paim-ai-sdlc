---
name: optimize-cloud-cost
description: 'Use when reducing cloud expenses, analyzing infrastructure costs, right-sizing resources, implementing cost governance policies, or optimizing reserved/spot pricing across AWS, Azure, or GCP.'
---
...
**Reference:** See `references/tagging-standards.md` for full tagging conventions and enforcement rules.
...
- `architecture-design` — for designing infrastructure architecture before cost optimization
- `codebase-analysis` — for auditing existing IaC and resource definitions
